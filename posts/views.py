# <------------------- METHOD-1(Normal views using basic methods) ------------------->
...
# <------------------- METHOD-2(Function based views using @api_view) ------------------->
...
# <------------------- METHOD-3(Class based views using APIViews) ------------------->
...
# <------------------- METHOD-4(Class based views using Generics & Mixins) ------------------->
...
# <------------------- METHOD-5(Class based views using Generics only) ------------------->
